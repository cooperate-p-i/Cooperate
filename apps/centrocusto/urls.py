...
from .views import CreateCentroCusto, UpdateCentroCusto,DeleteCentroCusto,ListCentroCusto

urlpatterns = [

    path('novo', CreateCentroCusto.as_view(), name = 'create_centrocusto'),
    path('list/<int:familia_id>', ListCentroCusto.as_view(), name = 'list_centrocusto'),
